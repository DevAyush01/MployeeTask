    ...
    <div className="bg-white rounded-lg shadow p-4 md:p-6">
      <div className="border-b pb-4 mb-4">
        ...
        <div className="flex flex-wrap gap-2 mt-2">
          <span className="text-xs md:text-sm bg-gray-100 text-gray-800 px-2 py-1 rounded">
            {job.employment_type}
          </span>
          <span className="text-xs md:text-sm bg-gray-100 text-gray-800 px-2 py-1 rounded">
      ...
      <a
        ...
        className="inline-block w-full md:w-auto text-center bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors"
      >
        Apply Now
      </a>
    </div>
